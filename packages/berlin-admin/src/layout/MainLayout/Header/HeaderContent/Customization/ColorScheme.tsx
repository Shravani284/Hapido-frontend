...
const ColorScheme = () => {
  ...
  const colorOptions: ColorProps[] = [
    ...
    },
    {
      ...
      label: 'Theme 1',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#305bdd' : '#3366FF',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 2',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#655ac8' : '#7265E6',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 3',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#0a7d3e' : '#068e44',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 4',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#5d7dcb' : '#3c64d0',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 5',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#d26415' : '#f27013',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 6',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#288d99' : '#2aa1af',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 7',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#05934c' : '#00a854',
        0.2
      )}`,
    },
    {
      ...
      label: 'Theme 8',
      shadow: `0 0 0 2px ${alpha(
        mode === ThemeMode.DARK ? '#058478' : '#009688',
        0.2
      )}`,
    },
  ];
