              ...
              <div>
                {formik.values.deal_descriptions?.map(
                  (name: string, index: number) => {
                    const enTitle = formik.values.deal_descriptions[
                      index
                    ]?.translations.findIndex(
                      (e: any) =>
                        e.column_name === 'description_title_trans_ids' &&
                        e.locale === 'en'
                    );
                    const arTitle = formik.values.deal_descriptions[
                      index
                    ]?.translations.findIndex(
                      (e: any) =>
                        e.column_name === 'description_title_trans_ids' &&
                    ...
                    const enDetail = formik.values.deal_descriptions[
                      index
                    ]?.translations.findIndex(
                      (e: any) =>
                        e.column_name === 'description_detail_trans_ids' &&
                        e.locale === 'en'
                    );
                    const arDetail = formik.values.deal_descriptions[
                      index
                    ]?.translations.findIndex(
                      (e: any) =>
                        e.column_name === 'description_detail_trans_ids' &&
