  ...
  const itemData = [
    {
      img: appIcon,
      title: 'appIcon',
      link: 'https://apps.apple.com/us/app/hapido-deals-discounts/id6477384738',
    },
    {
      img: googlePlay,
      title: 'googlePlay',
      link: 'https://play.google.com/store/apps/details?id=com.hapido.app',
    },
  ];
  ...
  const bottomRouts = (newValue) => {
    ...
    switch (newValue) {
      ...
      case 1:
        ...
        break;
      case 2:
        navigate(`/${lang}/search?q=flash%20sale`);
        break;
      case 4:
    ...
    <>
      <div className={css.footer}>
        <Container maxWidth={'xl'}>
          ...
          >
            <Grid item lg={5} xs={0} md={5} className={css.footerTop}>
              <div className={css.footertopDiv}>
...
Terms & Conditions (This is customers one) */}
          ...
          <Grid container>
            ...
            <Grid item xl={5} xs={6} md={6} className={css.footerLogo}>
      ...
      {size < 768 ? (
        <>
          <Box
            ...
            bottom={'0'}
            zIndex={'1'}
            className={`${css.bottomNavigation} mobileFooter`}
          >
            <BottomNavigation
              showLabels
              value={value}
