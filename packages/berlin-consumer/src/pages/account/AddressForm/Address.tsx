        ...
        {size < 768 ? (
          <>
            ...
            <div className={css.accountHeader}>
              <p className={css.accountTitle}>{t(`ADDRESS`)}</p>
              <button className={css.addBtnMob} onClick={handleClickOpenAdd}>
                {t(`ADD_NEW`)}
              </button>
            </div>
          </>
          ...
          <div className={css.title}>
            {t(`ALL_ADDRESSES`)}
            <button className={css.addBtn} onClick={handleClickOpenAdd}>
              <img
                loading="lazy"
                src={add}
                alt={t('ADD_ADDRESS')}
                className={css.addSymbol}
              />
              {t(`ADD_ADDRESS`)}
            </button>
          </div>
              ...
              <div key={item.id}>
                <Card className={css.singleCard}>
                  <div className={css.imageContainer}>
                    ...
                    <label className={css.addressTypeLabel}>
                      {item.address_label}
                    </label>
                    <img
