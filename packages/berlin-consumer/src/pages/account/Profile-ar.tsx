...
import { lang } from '../../../../../packages/berlin-consumer/src/utils/getLang';
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={12} lg={6} xl={6}>
                  ...
                  <div role="group" className={css.radioField}>
                    ...
                    <label className={`${css.leftSpace} RTLRightSpace`}>
                      <Field
                        style={{
                          marginLeft: '10px',
                        }}
                ...
                <Grid item xs={12} sm={12} lg={12} xl={12}>
                  ...
                  >
                    <div className={`${css.countryFlag} RTLCountryFlag`}>
                      <PhoneInput
                        international
                  ...
                  <div className={css.categoryInterest}>
                    {categoryList?.map(
                      (item: { id: number; label: string }) => {
                        return (
                          <div
                            className={`${css.categoryInterestItem} RTLCategoryInterestItem`}
                            key={item.id}
                          >
                            <FormControlLabel
                              control={
