        ...
        <Grid container className={css.mobilePadding}>
          <Grid item xs={9}>
            ...
            <div className={css.iconBox}>
              <ScheduleIcon />
              <p>
                {t('BOOKED_ON')}:{DateFormat(details.booking_date)}
                {/* 18 Aug, 2023 - 9:34 PM // */}
              </p>
            </div>
          </Grid>
                    ...
                    <div className="upload__image-wrapper">
                      ...
                      {errors && (
                        <div className={css.addImageValidation}>
                          ...
                          {errors.acceptType && (
                            <span>{t('YOU_SELECTED_FILE_TYPE_IS_NOT_ALLOWED')}</span>
                          )}
                          {errors.maxFileSize && (
                          ...
                          {errors.resolution && (
                            <span>
                              {t('SELECTED_FILE_DOES_NOT_MATCH_YOUR_DESIRED_RESOLUTION')}
                            </span>
                          )}
                        </div>
                      )}
