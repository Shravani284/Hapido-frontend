      ...
      <div className={css.sidebarMobile}>
        <div>
          ...
          <div
            ...
            className={'RTLCloseDrawer'}
          >
            <CloseIcon style={{ fontSize: '25px' }} />
          </div>
        </div>
        <Divider style={{ margin: '15px 0' }} />
        <label className={`RTLSidebarMenuTitle`}>{t(`MY_ACCOUNT`)}</label>
        <ul className={`${css.sidebarList} RTLSidebarList`}>
          {sidebarNavItems.map((val, index) => {
            ...
            return (
              <Link key={index} to={myAccountLink(val.section)}>
                ...
                >
                  <div className={`RTLIcon`}>{val.icon}</div>
                  <div className={`RTLText`}>{val.display}</div>
                  <div className={`RTLRightIcon`}>
          ...
          >
            ...
            <div style={{ fontWeight: 'bold' }} className={`RTLText`}>
              {t(`LOGOUT`)}
            </div>
          </li>
        </ul>
...
export default MobileSideMenuAr;
