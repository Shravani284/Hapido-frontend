            ...
            isSkeletonFeature ? (
              ...
              >
                <Box
                  ...
                  className={`${css.travelDealsCardRes} RTLComponent`}
                  m={1}
                  gap={1}
                >
                  <>
                    ...
                    <Box overflow={'hidden'} className="travelText">
                      ...
                      <p className={`${css.travelOfferRes} RTLTravelOfferRes`}>
                        {item?.tagline_label}
                      </p>
                      ...
                      <Rating
                        ...
                        readOnly
                        size="small"
                        className={`${css.ratingRes} RTLRating`}
                        dir="rtl"
                      />
