...
const TravelDeals = ({ doubleColumn }: any) => {
              ...
              {doubleColumnList?.map((item, index) => (
                ...
                >
                  <Box
                    ...
                    // }
                  >
                    <Box mr={2} className={css.cardContainerWidth}>
                      <img
                        loading="lazy"
                    ...
                    <Box overflow={'hidden'} className="travelText">
                      ...
                      <Box mt={1} className={css.beforeText}>
                        {t('BEFORE')}
                      ...
                      <Box className={css.location} mb={1}>
