...
import PackageOptionCardAr from './packageOptions/PackageOptionCard-ar';
import ProductDetailResAr from './ProductDetailsResponsive/index-ar';
import ProductOverviewAr from './productOverview/index-ar';
import ScheduleAr from './ticketsHighlightAndSecdule/Schedule/Schedule-ar';
...
const ProductDetailsAr = () => {
  ...
  useEffect(() => {
    viewPageEvent(mPage.productDetail, currentCity, prevLocation);
  }, [id]);
                  ...
                  <>
                    <Box className={css.mainSlider}>
                      ...
                      <Grid
                        ...
                        position="relative"
                        className={`${css.productInfo} RTLproductInfo`}
                      >
                        <Grid>
                          <h4 id="buyProduct">
                            {productDetailsInfo?.title_label}
                          ...
                          <div className={`${css.rating} RTLrating`}>
                            <Rating
                          ...
                          <div
                            className={`${css.shareIconPlace} RTLshareIconPlace`}
                          >
                            <img
                              loading="lazy"
                              src={uploadIcon}
                    ...
                    <Grid container columnSpacing={3} rowSpacing={3}>
                      <Grid item lg={6} md={12} sm={12} xs={12}>
                        <HighlightAr productDetailsInfo={productDetailsInfo} />
                      </Grid>
                      <Grid item lg={6} md={12} sm={12} xs={12}>
                        {size >= 768 ? (
                          <ScheduleAr productDetailsInfo={productDetailsInfo} />
                        ) : (
                          ''
                        )}
                      </Grid>
