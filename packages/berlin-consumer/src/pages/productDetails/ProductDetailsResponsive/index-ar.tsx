...
import MobileScheduleAr from '../ticketsHighlightAndSecdule/Schedule/ScheduleMobile-ar';
import HighlightAr from '../ticketsHighlightAndSecdule/Highlight-ar';
import CarouselSlideAr from '../../../components/MainCarousel/CarouselSlide-ar';
const singleToExclude = [565, 566, 455];
const bundleToExclude = [889, 7788, 966, 36, 19];
const comboToExclude = [26, 6666, 5896];
const ProductDetailResAr = ({
  productDetailsInfo,
          ...
          <Container maxWidth="xl">
            <Box my={2}>
              <Box>
                <Grid
                  position="relative"
                  className={`${css.productInfoMob} RTLproductInfoMob`}
                >
                  <Grid>
                    ...
                    <div className={`${css.shareIconPlace} RTLshareIconPlace`}>
                      <img
                        loading="lazy"
                        src={uploadIcon}
                        alt={t(`UPLOADICON`)}
                ...
                <Box display={'flex'} alignItems={'center'} mt={1}>
                  <Box className={`${css.MobRating} RTLMobRating`}>
                  ...
                  <Box display={'flex'}>
                    <Box>
                      <div className={css.pAed}>
                        {productDetailsInfo?.selling_price}
                        {t(`AED`)}*
                      </div>
                    ...
                    <Box className={`${css.offer} RTLoffer`} fontSize={'10px'}>
                      {Math.ceil(productDetailsInfo?.discount_percentage)}%
                    </Box>
                  </Box>
                  <MobileScheduleAr productDetailsInfo={productDetailsInfo} />
                </Box>
              </>
            )}
          </Box>
            ...
            <Box className={css.productCard}>
              {productDetailBannerMob ? (
                ...
                <div className={css.cardHeader} key={index}>
                  ...
                  <Box
                    className={`${css.details} RTLdetails`}
              ...
              {productDetailBannerMob ? (
                ...
                >
                  ...
                  {deal_type === 'b' && (
                    <MobileScheduleAr productDetailsInfo={item} />
                  )}
                </Box>
              )}
            </Box>
...
export default ProductDetailResAr;
