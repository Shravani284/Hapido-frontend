export const getDealComponentAr = (selectedPackage, getCalendar) => {
...
export const getTimeSelectionComponentAr = (selectedPackage) => {
...
export const getPayloadAr = (selectedData, productDetailsInfo, deal_type) => {
  let count = null;
  let quantity = null;
  let price_type = null;
  let price = null;
...
export const getPayloadMobileAr = (
  selectedData,
  productDetailsInfo,
  deal_type,
  id
