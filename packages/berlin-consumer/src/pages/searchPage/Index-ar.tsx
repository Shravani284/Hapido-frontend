...
import SearchListingMobileAr from './device/mobile-ar';
import SearchListingWebAr from './device/index-ar';
  ...
  return (
    <>
      ...
      <Container maxWidth="xl">
        {size < 992 ? <SearchListingMobileAr /> : <SearchListingWebAr />}
        {/* <Helmet>
