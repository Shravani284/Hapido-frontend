...
const CategoryListingWeb = ({ setDescParams }: any) => {
  ...
  return (
    <>
      <Header ResetHandler={() => resetHandlerHeader()} />
      <Container maxWidth="xl">
        ...
        <Box mt={1} className={css.categoryBreadcrumb}>
        ...
        <Box className={css.categorySlider}>
          {categoryBanner ? (
            <SkeletonCategoryBanner />
          ) : (
            <CarouselSlide
...
export default CategoryListingWeb;
